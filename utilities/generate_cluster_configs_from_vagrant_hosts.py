...
def generate_cluster_configs_from_vagrant(private_network, public_network, public_network_ethernet, x509_certs):
    """
    ...
    generate_clusters_from_pool(pool_file, x509_certs=x509_certs)
...
if __name__ == "__main__":
    ...
    generate_cluster_configs_from_vagrant(opts.private_network, opts.public_network, opts.public_network_ethernet, opts.x509_certs)
