...
class ClusterKeywords:
    ...
    def provision_cluster(self, cluster_config, server_version, sync_gateway_version, sync_gateway_config, ssl=False):
        ...
        provision_cluster(cluster_config, cbs_config, sg_config, ssl)
