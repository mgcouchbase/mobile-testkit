...
from utilities.cluster_config_utils import get_sg_upgraded_version
...
class SyncGateway(object):
    ...
    def redeploy_sync_gateway_config(self, cluster_config, sg_conf, url, sync_gateway_version, enable_import=False, enable_xattrs=False, enable_views=False):
