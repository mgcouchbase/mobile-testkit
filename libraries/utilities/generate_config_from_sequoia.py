...
def verify_hosts(host_json, num_servers, num_sync_gateways, num_accels, num_lbs):
    ...
    if len(host_json['load_balancers']) != num_lbs:
        raise ValueError('Make sure you have the correct number of lbs')
...
def generate_config_from_sequoia(host_file, topology, ipv6):
